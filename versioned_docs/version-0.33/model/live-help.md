...
- The `patchId` of the help `PatchDefinitionV02`.
...
Copying from help produces the same `GraphFragmentV02` clipboard payload as
...
copies the help `PatchDefinitionV02` into the user's project `patchLibrary`
