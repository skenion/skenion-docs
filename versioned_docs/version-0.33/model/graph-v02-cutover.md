...
Graph v0.2 is the active graph and project model for the Skenion 0.33 Manual.
New Studio, Runtime, SDK, examples, packages, and Manual behavior should use
`ProjectDocumentV02`, `GraphDocumentV02`, patch libraries,
