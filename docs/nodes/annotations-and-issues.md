...
Annotation and issue nodes are graph nodes that help users understand or
...
node's `objectResolution` state and issues. Runtime should keep the
...
unresolved, or invalid, and returns structured issues for Studio to show.
