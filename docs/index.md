...
strict v0 version rejection, lockstep product train artifacts, install artifact
tiers, and the rule that public Manual pages name exact current versions rather
than broad ranges or fallback aliases.
